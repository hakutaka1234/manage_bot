...
from HakutakaRobot import pbot as app
from HakutakaRobot import arq
from HakutakaRobot.services.keyboard import Ikb
from HakutakaRobot.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from HakutakaRobot.services.tasks import _get_tasks_text, all_tasks, rm_task
from HakutakaRobot.services.types import InlineQueryResultCachedDocument
from HakutakaRobot.modules.info import get_chat_info, get_user_info
from HakutakaRobot.modules.music import download_youtube_audio
from HakutakaRobot.utils.functions import test_speedtest
from HakutakaRobot.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/HakutakaRobot_bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[HakutakaRobot️](https://t.me/HakutakaRobot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/HakutakaRobot)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
