...
from HakutakaRobot import telethn as bot
from HakutakaRobot.modules.urluploader import download_file
from HakutakaRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @HakutakaRobot",
            )
        except Exception as e:
            traceback.print_exc()
