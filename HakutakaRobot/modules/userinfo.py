...
from HakutakaRobot.__main__ import STATS, TOKEN, USER_INFO
from HakutakaRobot.modules.sql import SESSION
import HakutakaRobot.modules.sql.userinfo_sql as sql
from HakutakaRobot.modules.disable import DisableAbleCommandHandler
from HakutakaRobot.modules.sql.global_bans_sql import is_user_gbanned
from HakutakaRobot.modules.sql.afk_sql import is_afk, set_afk
from HakutakaRobot.modules.sql.users_sql import get_user_num_chats
from HakutakaRobot.modules.helper_funcs.chat_status import sudo_plus
from HakutakaRobot.modules.helper_funcs.extraction import extract_user
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/alivenotalliance"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/alivenotalliance")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "❂ <b>Stats For <a href='https://t.me/HakutakaRobot'>HakutakaRobot</a>:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
