...
async def _(event):
    ...
    im1 = Image.open("HakutakaRobot/resources/Haku.png")
    if ik.endswith(".tgs"):
        await tbot.download_media(reply, "Haku.tgs")
        os.system("lottie_convert.py Haku.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        jsn = jsn.replace("512", "2000")
        open = ("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json Haku.tgs")
        file = "Haku.tgs"
        os.remove("json.json")
