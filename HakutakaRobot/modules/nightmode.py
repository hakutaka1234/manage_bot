import os
from HakutakaRobot.modules.sql.night_mode_sql import (
    add_nightmode,
    rmnightmode,
    get_all_chat_id,
    is_nightmode_indb,
...
from HakutakaRobot import telethn as tbot, OWNER_ID
...
async def job_open():
    ...
    for pro in chats:
        try:
            await tbot.send_message(
              int(pro.chat_id), "06:00 Am, Group Is Opening.\n**Powered By [〲༆ʜᴀᴋᴜ ᴀʟɪᴠᴇ ༇〺](t.me/HakutakaRobot)**"
            )
            await tbot(
            functions.messages.EditChatDefaultBannedRightsRequest(
