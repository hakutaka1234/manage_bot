...
import HakutakaRobot.modules.sql.notes_sql as sql
from HakutakaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from HakutakaRobot.__main__ import DATA_IMPORT
from HakutakaRobot.modules.helper_funcs.chat_status import user_admin
from HakutakaRobot.modules.helper_funcs.alternate import typing_action

# from HakutakaRobot.modules.rules import get_rules
import HakutakaRobot.modules.sql.rules_sql as rulessql

# from HakutakaRobot.modules.sql import warns_sql as warnssql
import HakutakaRobot.modules.sql.blacklist_sql as blacklistsql
from HakutakaRobot.modules.sql import disable_sql as disabledsql

# from HakutakaRobot.modules.sql import cust_filters_sql as filtersql
# import HakutakaRobot.modules.sql.welcome_sql as welcsql
import HakutakaRobot.modules.sql.locks_sql as locksql
from HakutakaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("HakutakaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("HakutakaRobot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `HakutakaRobot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("HakutakaRobot{}.backup".format(chat_id))  # Cleaning file
